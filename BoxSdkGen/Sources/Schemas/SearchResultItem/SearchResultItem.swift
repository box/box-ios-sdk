...
/// An item in search results. This can be a file, folder, or web link.
public enum SearchResultItem: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(SearchResultItem.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "The type of the decoded object cannot be determined."))
