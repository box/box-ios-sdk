...
public class MetadataTaxonomyNodes: Codable, RawJSONReadable {
    ...
    /// A list of metadata taxonomy nodes.
    public let entries: [MetadataTaxonomyNode]?

    /// Initializer for a MetadataTaxonomyNodes.
    ///
    /// - Parameters:
    ...
    ///   - entries: A list of metadata taxonomy nodes.
    public init(limit: Int64? = nil, nextMarker: TriStateField<String> = nil, prevMarker: TriStateField<String> = nil, entries: [MetadataTaxonomyNode]? = nil) {
        self.limit = limit
    ...
    required public init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([MetadataTaxonomyNode].self, forKey: .entries)
    }
