...
/// A generic error.
public class ClientErrorV2026R0: Codable, RawJSONReadable {
    ...
    public let type: ClientErrorV2026R0TypeField?

    /// The HTTP status of the response.
    public let status: Int?

    /// A Box-specific error code.
    public let code: ClientErrorV2026R0CodeField?
    ...
    /// Initializer for a ClientErrorV2026R0.
    ///
    /// - Parameters:
    ...
    ///     when contacting Box support.
    public init(type: ClientErrorV2026R0TypeField? = nil, status: Int? = nil, code: ClientErrorV2026R0CodeField? = nil, message: String? = nil, contextInfo: TriStateField<[String: AnyCodable]> = nil, helpUrl: String? = nil, requestId: String? = nil) {
        self.type = type
        self.status = status
        self.code = code
    ...
    required public init(from decoder: Decoder) throws {
        ...
        type = try container.decodeIfPresent(ClientErrorV2026R0TypeField.self, forKey: .type)
        status = try container.decodeIfPresent(Int.self, forKey: .status)
        code = try container.decodeIfPresent(ClientErrorV2026R0CodeField.self, forKey: .code)
