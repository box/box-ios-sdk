...
/// resources.
public class UserMiniV2026R0: UserBaseV2026R0 {
    ...
    /// Initializer for a UserMiniV2026R0.
    ///
    /// - Parameters:
    ...
    public init(id: String, type: UserBaseV2026R0TypeField = UserBaseV2026R0TypeField.user, name: String? = nil, login: String? = nil) {
        self.name = name
        self.login = login
