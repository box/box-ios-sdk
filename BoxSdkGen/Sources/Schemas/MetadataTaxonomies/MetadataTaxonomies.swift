...
public class MetadataTaxonomies: Codable, RawJSONReadable {
    ...
    /// A list of metadata taxonomies.
    public let entries: [MetadataTaxonomy]?

    /// Initializer for a MetadataTaxonomies.
    ///
    /// - Parameters:
    ...
    ///   - entries: A list of metadata taxonomies.
    public init(limit: Int64? = nil, nextMarker: TriStateField<String> = nil, prevMarker: TriStateField<String> = nil, entries: [MetadataTaxonomy]? = nil) {
        self.limit = limit
    ...
    required public init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([MetadataTaxonomy].self, forKey: .entries)
    }
