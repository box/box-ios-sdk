...
/// A recently accessed item resource. This can be a file, folder, or web link.
public enum RecentItemResource: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(RecentItemResource.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "The type of the decoded object cannot be determined."))
