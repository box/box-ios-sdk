...
public class EnterpriseConfigurationItemStringV2025R0: EnterpriseConfigurationItemV2025R0 {
    ...
    /// Initializer for a EnterpriseConfigurationItemStringV2025R0.
    ///
    /// - Parameters:
    ///   - isUsed: Indicates whether a configuration is used for a given enterprise.
    ///   - value: The value of the enterprise configuration as a string.
