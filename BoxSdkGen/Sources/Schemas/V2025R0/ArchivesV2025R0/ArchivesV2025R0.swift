...
/// A list of archives.
public class ArchivesV2025R0: Codable, RawJSONReadable {
    ...
    public let entries: [ArchiveV2025R0]?
    ...
    /// Initializer for a ArchivesV2025R0.
    ///
    /// - Parameters:
    ///   - entries: A list in which each entry represents an archive object.
    ///   - limit: The limit that was used for these entries. This will be the same as the
    ///     `limit` query parameter unless that value exceeded the maximum value
    ///     allowed. The maximum value varies by API.
    ///   - nextMarker: The marker for the start of the next page of results.
    public init(entries: [ArchiveV2025R0]? = nil, limit: Int64? = nil, nextMarker: TriStateField<String> = nil) {
    ...
    required public init(from decoder: Decoder) throws {
        ...
        entries = try container.decodeIfPresent([ArchiveV2025R0].self, forKey: .entries)
