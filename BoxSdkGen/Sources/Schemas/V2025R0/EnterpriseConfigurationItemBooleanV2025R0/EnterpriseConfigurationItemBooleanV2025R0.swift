...
public class EnterpriseConfigurationItemBooleanV2025R0: EnterpriseConfigurationItemV2025R0 {
    ...
    @CodableTriState public private(set) var value: Bool?

    /// Initializer for a EnterpriseConfigurationItemBooleanV2025R0.
    ///
    /// - Parameters:
    ///   - isUsed: Indicates whether a configuration is used for a given enterprise.
    ///   - value: The value of the enterprise configuration as a boolean.
    public init(isUsed: Bool? = nil, value: TriStateField<Bool> = nil) {
