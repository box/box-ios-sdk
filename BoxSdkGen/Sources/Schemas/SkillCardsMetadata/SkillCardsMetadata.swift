...
public class SkillCardsMetadata: Codable, RawJSONReadable {
    ...
    public init(canEdit: Bool? = nil, id: String? = nil, parent: String? = nil, scope: String? = nil, template: String? = nil, type: String? = nil, typeVersion: Int64? = nil, version: Int64? = nil, cards: [SkillCard]? = nil) {
