...
public class ExternalUsersManager {
    ...
    ///
    /// - Parameters:
    ///   - requestBody: Request body of submitJobToDeleteExternalUsersV2025R0 method
    ///   - headers: Headers of submitJobToDeleteExternalUsersV2025R0 method
    /// - Returns: The `ExternalUsersSubmitDeleteJobResponseV2025R0`.
    /// - Throws: The `GeneralError`.
    public func submitJobToDeleteExternalUsersV2025R0(requestBody: ExternalUsersSubmitDeleteJobRequestV2025R0, headers: SubmitJobToDeleteExternalUsersV2025R0Headers = SubmitJobToDeleteExternalUsersV2025R0Headers()) async throws -> ExternalUsersSubmitDeleteJobResponseV2025R0 {
