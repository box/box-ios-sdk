...
public class GetMetadataTemplateFieldOptionsQueryParams {
    ...
    /// Defaults to `true`.
    public let onlySelectableOptions: Bool?
    ...
    /// Initializer for a GetMetadataTemplateFieldOptionsQueryParams.
    ///
    /// - Parameters:
    ...
    ///     The response will compute counts of up to 10,000 elements. Defaults to `false`.
    ///   - onlySelectableOptions: When set to `true`, this only returns valid selectable options for this template
    ///     taxonomy field. Otherwise, it returns all taxonomy nodes, whether or not they are selectable.
    ///     Defaults to `true`.
    ...
    public init(level: [Int64]? = nil, parent: [String]? = nil, ancestor: [String]? = nil, query: String? = nil, includeTotalResultCount: Bool? = nil, onlySelectableOptions: Bool? = nil, marker: String? = nil, limit: Int64? = nil) {
        self.level = level
        self.parent = parent
        self.ancestor = ancestor
        self.query = query
        self.includeTotalResultCount = includeTotalResultCount
        self.onlySelectableOptions = onlySelectableOptions
        self.marker = marker
        self.limit = limit
    }
