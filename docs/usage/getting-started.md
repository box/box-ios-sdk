...
Any use of this software is governed by the attached [Box SDK Beta Agreement](../../BETA-AGREEMENT.md).  If you do not
accept the terms of the Box SDK Beta Agreement, you may not use this software.
