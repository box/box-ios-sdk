...
```
try await client.hubDocument.getHubDocumentPagesV2025R0(queryParams: GetHubDocumentPagesV2025R0QueryParams(hubId: hubId))
```
...
```
try await client.hubDocument.getHubDocumentBlocksV2025R0(queryParams: GetHubDocumentBlocksV2025R0QueryParams(hubId: hubId, pageId: pageId))
```
