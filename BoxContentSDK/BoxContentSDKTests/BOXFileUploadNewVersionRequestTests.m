...
- (void)test_that_upload_from_asset_has_expected_URLRequest
{
    ...
    BOXFileUploadNewVersionRequest *request = [[BOXFileUploadNewVersionRequest alloc] initWithFileID:fileID ALAsset:assetMock assetsLibrary:nil];
    NSURLRequest *URLRequest = request.urlRequest;
...
- (void)test_that_upload_from_asset_with_content_dates_and_matching_etag_has_expected_URLRequest
{
    NSString *uploadData = @"hello";
    NSString *fileID = @"123";
    NSString *matchingEtag = @"uicns46563";
