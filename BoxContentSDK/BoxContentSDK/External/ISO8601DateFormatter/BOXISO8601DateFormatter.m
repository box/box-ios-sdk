...
- (NSTimeZone *) defaultTimeZone {
    return defaultTimeZone ?: [NSTimeZone defaultTimeZone];
}
...
- (NSString *) stringFromDate:(NSDate *)date {
    return [self stringFromDate:date timeZone:self.defaultTimeZone];
}
...
- (NSString *) stringFromDate:(NSDate *)date timeZone:(NSTimeZone *)timeZone {
    switch (self.format) {
        ...
        default:
            [NSException raise:NSInternalInconsistencyException format:@"self.format was %tu, not calendar (%tu), week (%tu), or ordinal (%tu)", self.format, BOXISO8601DateFormatCalendar, BOXISO8601DateFormatWeek, BOXISO8601DateFormatOrdinal];
            return nil;
    }
}
...
- (NSString *) stringFromDate:(NSDate *)date formatString:(NSString *)dateFormat timeZone:(NSTimeZone *)timeZone {
    ...
    if (!unparsingFormatter) {
        ...
        unparsingFormatter.locale = [NSLocale localeWithLocaleIdentifier:@"en_US_POSIX"];
    }
