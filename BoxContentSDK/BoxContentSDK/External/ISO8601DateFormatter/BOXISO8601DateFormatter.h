 ...
 */
enum {
	BOXISO8601DateFormatCalendar,
	BOXISO8601DateFormatOrdinal,
	BOXISO8601DateFormatWeek,
};
typedef NSUInteger BOXISO8601DateFormat;

//The default separator for time values. Currently, this is ':'.
extern unichar BOXISO8601DefaultTimeSeparatorCharacter;
...
@property (nonatomic, readwrite, assign) BOOL parsesStrictly;
...
@property (nonatomic, readwrite, assign) BOXISO8601DateFormat format;
@property (nonatomic, readwrite, assign) BOOL includeTime;
@property (nonatomic, readwrite, assign) unichar timeSeparator;
