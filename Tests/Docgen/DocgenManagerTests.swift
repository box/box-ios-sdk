...
class DocgenManagerTests: RetryableTestCase {
    ...
    public func testDocgenBatchAndJobs() async throws {
        await runWithRetryAsync {
            ...
            let indexOfItem: Int = docgenJobs.entries!.count - 1
            let docgenJobItemFromList: DocGenJobFullV2025R0 = docgenJobs.entries![indexOfItem]
            let docgenJob: DocGenJobV2025R0 = try await client.docgen.getDocgenJobByIdV2025R0(jobId: docgenJobItemFromList.id)
