...
/// An item in search results with a shared link. This can be a file, folder, or web link.
public enum SearchResultWithSharedLinkItem: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(SearchResultWithSharedLinkItem.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "The type of the decoded object cannot be determined."))
