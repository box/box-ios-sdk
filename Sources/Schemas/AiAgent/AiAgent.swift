...
public enum AiAgent: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(AiAgent.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "The type of the decoded object cannot be determined."))
