...
public enum FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        throw DecodingError.typeMismatch(FileReferenceOrFolderReferenceOrWeblinkReferenceV2025R0.self, DecodingError.Context(codingPath: decoder.codingPath, debugDescription: "The type of the decoded object cannot be determined."))
